...
import com.invoice.ahamed.adapter.ItemDiscountSettingAdapter
import com.invoice.ahamed.database.Discount
import com.invoice.ahamed.database.InvoiceDatabase
import com.invoice.ahamed.databinding.ActivitySettingBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnAdd.setOnClickListener {
            ...
            val discount = Discount(
                ...
                price = price,
                isPlus = binding.isAdd.isOn,
                isActive = binding.isActive.isOn,
